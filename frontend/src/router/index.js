...
const routes = [
  ...
  // --- 个人中心模块 ---
  {
    ...
    children: [
      ...
      { path: 'history', name: 'UserHistory', component: () => import('@/views/user/History.vue'), meta: { title: '我的足迹' } },
    ]
  },
  ...
  // 后台管理模块
  {
    ...
    children: [
      ...
      { path: 'verify', name: 'AdminVerify', component: () => import('@/views/admin/VerifyList.vue'), meta: { title: '实名认证审核' }},
      { path:'categories', name: 'AdminCategories', component: () => import('@/views/admin/CategoryList.vue'), meta: { title: '商品分类与属性管理' }},
    ]
  }
]
